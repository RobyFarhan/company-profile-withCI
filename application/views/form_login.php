...
<body>
	...
	<!-- start form login -->
		<div class="container" align="center">
			<div class="col-md-6 banner-btmg">
				<div class="banner-btmg1">
					...
					<form action="<?php echo base_url()?>login/signin" method="post">
						<div class="sec-left">
							...
							<input type="text" id="username" name="username" placeholder="Insert Username" autocomplete="off" required />
							<div class="clearfix"> </div>
						</div>
						<div class="sec-right">
							<label class="contact-form-text">Password</label>
							<input type="password" id="password" name="password" placeholder="Insert Password" autocomplete="off" required />
							<div class="clearfix"> </div>
						</div>
						<br />
	...
	<section class="footer py-md-5">
		...
		<div class="row footer_inner_info_w3ls_agileits">
			<div class="col-md-3 footer-left">
				<h2><a href="<?php echo base_url();?>"> Shipping</a></h2>
